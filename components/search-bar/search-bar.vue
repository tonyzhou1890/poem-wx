<template>
	<view class="uni-searchbar" :style="{padding: padding + 'rpx'}">
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor, borderWidth: borderWidth + 'px'}" class="uni-searchbar__box" @click="searchClick">
			<!-- #ifdef MP-ALIPAY -->
